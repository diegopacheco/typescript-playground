 ...
 * the result is simply Type. Otherwise, a new function type 
 * with no this parameter is created from Type. 
 * Generics are erased and only the last overload signature is propagated
 * into the new function type.
 **/
